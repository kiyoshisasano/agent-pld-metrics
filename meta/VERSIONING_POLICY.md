...
|-------|------------|-------|
| PLD Event Schema (`schema_version`) | Yes | Used for runtime validation |
| Repository version (`meta`) | Yes | Describes documentation and project evolution |
...
| `schema_version` value | Acceptance |
|------------------------|------------|
| `2.0` | ✅ Accept |
...
| Formatting improvements | spacing, layout, organization | PATCH |
